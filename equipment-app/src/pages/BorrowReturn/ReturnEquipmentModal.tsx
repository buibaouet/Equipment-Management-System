  ...
  const handleConfirm = useCallback(
    async () => {
      ...
      try {
        ...
        const response = await returnEquipment({ id: equipment?.id, status: Number(selectedStatus) as EquipmentStatusEnum }).unwrap();
        ...
        toast.error(error?.message || "Có lỗi xảy ra khi trả thiết bị");
      } finally {
        setIsSubmitting(false);
      }
    },
    [actionCallback, equipment, selectedStatus]
  );
